export const name = 'task_template';
export const description = 'Standard task definition template';
export const filename = 'task_template.md';
export const content = `# {{id}}: {{title}}
...
## Deliverables
- code changes
- report at \`reports/tasks/<ADR>/<task_id>_report.md\``;
